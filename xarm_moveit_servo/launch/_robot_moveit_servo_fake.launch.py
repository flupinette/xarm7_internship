...
def launch_setup(context, *args, **kwargs):
    ...
    add_orbbec_astra = LaunchConfiguration('add_orbbec_astra', default=False)
    add_orbbec_astra_links = LaunchConfiguration('add_orbbec_astra_links', default=True)
    ...
    moveit_config = MoveItConfigsBuilder(
        ...
        add_orbbec_astra=add_orbbec_astra,
        add_orbbec_astra_links=add_orbbec_astra_links,
